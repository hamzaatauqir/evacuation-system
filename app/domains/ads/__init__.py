...
- Management is strictly admin-role only; the public surface is the homepage
  payload (public_payload_json) and the read-only /ads/media/* image route.
"""
from .core import configure
from .schema import ensure_schema
from .routes import handle_get, handle_post, matches_path
from .service import public_payload_json

__all__ = ['configure', 'ensure_schema', 'handle_get', 'handle_post',
           'matches_path', 'public_payload_json']
