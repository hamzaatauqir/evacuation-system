...
.hdr .flag{font-size:2em;margin-bottom:6px}.hdr .flag-img{width:84px;height:56px;object-fit:cover;border-radius:6px;box-shadow:0 2px 10px rgba(0,0,0,.2);border:1px solid rgba(255,255,255,.35)}
