...
export type IconName =
  | "user-add" | "user" | "users" | "home" | "alert" | "exit" | "scale"
  | "heart" | "mail" | "phone" | "search" | "filter" | "download" | "check"
  | "x" | "chevron-r" | "chevron-d" | "chevron-l" | "eye" | "clock" | "grid"
  | "logout" | "menu" | "info" | "note" | "flag" | "building" | "transit"
  | "star" | "tag";
...
export function Icon({ name, size = 20, color = "currentColor", style }: IconProps) {
  ...
  switch (name) {
    ...
    case "scale":
      return (<svg {...p}><line x1="12" y1="3" x2="12" y2="21"/><path d="M3 9l9-6 9 6"/><path d="M3 9a9 9 0 0 0 9 9 9 9 0 0 0 9-9"/></svg>);
    case "heart":
    ...
    case "phone":
      return (<svg {...p}><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 13a19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 3.6 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/></svg>);
    case "search":
    ...
    case "x":
      return (<svg {...p} strokeWidth={2}><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>);
    case "chevron-r":
      return (<svg {...p} strokeWidth={2}><polyline points="9 18 15 12 9 6"/></svg>);
    case "chevron-d":
      return (<svg {...p} strokeWidth={2}><polyline points="6 9 12 15 18 9"/></svg>);
    case "chevron-l":
      return (<svg {...p} strokeWidth={2}><polyline points="15 18 9 12 15 6"/></svg>);
    case "eye":
    ...
    case "logout":
      return (<svg {...p}><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><polyline points="16 17 21 12 16 7"/><line x1="21" y1="12" x2="9" y2="12"/></svg>);
    case "menu":
      return (<svg {...p} strokeWidth={2}><line x1="3" y1="12" x2="21" y2="12"/><line x1="3" y1="6" x2="21" y2="6"/><line x1="3" y1="18" x2="21" y2="18"/></svg>);
    case "info":
    ...
    case "building":
      return (<svg {...p}><rect x="4" y="2" width="16" height="20" rx="2"/><path d="M9 22v-4h6v4"/><path d="M8 6h.01M16 6h.01M12 6h.01M12 10h.01M8 10h.01M16 10h.01"/></svg>);
    case "transit":
